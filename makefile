...
AR=ar
OBJECTS_MAIN=main.o
OBJECTS_LIB_BASIC_LOOPS=advancedClassificationLoop.o basicClassififcation.o
OBJECTS_LIB_BASIC_REC=advancedClassificationRecursion.o basicClassififcation.o
CFLAGS= -Wall
...
recursived: $(OBJECTS_MAIN) libclassrec.so #3
	$(CC) $(CFLAGS) -fPIC $(OBJECTS_MAIN) -L. -lclassrec -o recursives
...
libclassloops.a: $(OBJECTS_LIB_BASIC_LOOPS)
	$(AR) -rcs libmylib.a $(OBJECTS_LIB_BASIC_LOOPS)	
...
basicClassififcation.o: basicClassififcation.c NumClass.h
	$(CC) $(CFLAGS) -c basicClassififcation.c
